    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('profile') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="address" class="block mt-1 w-full" type="email" name="address" :value="old('address')" required />
            </div>

            <div class="mt-4">
                <x-jet-label for="phone" value="{{ __('phone') }}" />
                <x-jet-input id="phone" class="block mt-1 w-full" type="email" name="phone" :value="old('phone')" required />
            </div>
